...
# 拉取PassWall源码
git clone -b packages --separate-git-dir c189a68728d6bb65d9fb4b47fdacea3ba970a624 https://github.com/xiaorouji/openwrt-passwall.git package/xiaorouji/packages
